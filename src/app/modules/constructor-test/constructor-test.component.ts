...
export class ConstructorTestComponent {
  ...
  constructor(@Inject('sourceFiles') private sourceFiles: any) {
    sourceFiles.files = ['constructor-test.component.scss'];
  }
  ...
  private createNode(
    ...
    margin: any = {},
    style: any = {},
    constraints: any = NodeConstraints.Default
  ): NodeModel {
    return {
      id: id,
      width: width,
  ...
  public nodes: NodeModel[] = [
    this.createNode('start', 40, 40, 35, 180, {
      type: 'Bpmn',
      shape: 'Event',
      event: { event: 'Start' },
    }),
    ...
    this.createNode(
      ...
      305,
      370,
      { type: 'Bpmn', shape: 'Event', event: { event: 'End' } },
      [
        {
          id: 'label2',
          content: 'Hazard',
    ...
    this.createNode('end', 40, 40, 665, 180, {
      type: 'Bpmn',
      shape: 'Event',
      event: { event: 'End' },
    }),
    ...
    this.createNode(
      ...
      0,
      0,
      { type: 'Bpmn', shape: 'Event', event: { event: 'Start' } },
      [],
      { left: 40, top: 80 }
    ),
    ...
    this.createNode(
      ...
      0,
      {
        type: 'Bpmn',
        shape: 'Event',
        event: { event: 'Intermediate', trigger: 'Error' },
      },
      [],
      { left: 350, top: 100 }
    ),
    ...
    this.createNode(
      ...
      0,
      {
        ...
        activity: {
          activity: 'Task',
          task: { type: 'User', compensation: true },
        },
      },
      [
        {
  ...
  public connectors: ConnectorModel[] = [
    ...
    this.createConnector(
      ...
      [
        ...
        { type: 'Orthogonal', length: 80, direction: 'Left' },
      ],
      [],
